...
const forgotPasswordRequest=asyncHandler(async(req,res)=>{
    ...
    const{ unHashedToken, hashedToken, tokenExpiry }=user.generatesTemporaryToken();

    user.forgetPasswordToken=hashedToken
    user.forgotPasswordRequest=tokenExpiry
    ...
    return res
        ...
        .json(
            new ApiResponse(
                200,
                {},
                "Password reset mail is been send to your mail ID"
            )
        )
});
